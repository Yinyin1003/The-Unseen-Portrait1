...
Non-interactive demo with pre-set email
"""
...
class DemoCompleteWorkflow:
    def __init__(self):
        self.detector = BackDetector()
        self.email_sender = EmailSender()
        self.recipient_email = "rebecca.zyy103@gmail.com"  # 预设邮箱
    ...
    def start_detection_with_email(self):
        """开始检测并自动发送邮件"""
        print("=" * 60)
        print("🎭 The Unseen Portrait - Demo Complete Workflow")
        print("=" * 60)
        print("This system will:")
        print("1. Use pre-set email address")
...
def main():
    ...
    print("• Use pre-set email address")
