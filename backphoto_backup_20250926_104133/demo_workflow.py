...
class DemoWorkflow:
    ...
    def step2_set_email(self):
        """步骤2：设置邮箱地址"""
        print("\n📧 步骤2：设置邮箱地址")
        
        # 使用预设的邮箱地址
        self.current_email = "rebecca.zyy103@gmail.com"
        print(f"✅ 使用预设邮箱地址: {self.current_email}")
        print("💡 提示：您可以在代码中修改邮箱地址")
        return True
